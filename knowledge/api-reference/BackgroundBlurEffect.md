...
|------|------|-------------|
| BlurOnce | `bool` | Background blur effect of a View.     Applications can apply BackgroundBlurEffect as the example below :     <code>     BackgroundBlurEffect effect = new BackgroundBlurEffect();     view.SetRenderEffect(effect);     </code> |
...
|------|-----------|-------------|
| Finished | `EventHandler` | Background blur effect of a View.     Applications can apply BackgroundBlurEffect as the example below :     <code>     BackgroundBlurEffect effect = new BackgroundBlurEffect();     view.SetRenderEffect(effect);     </code> |

## Methods

| Name | Signature | Description |
|------|-----------|-------------|
| AddBlurStrengthAnimation | `void AddBlurStrengthAnimation(Animation animation, AlphaFunction alphaFunction, TimePeriod timePeriod, float fromValue, float toValue)` | Background blur effect of a View.     Applications can apply BackgroundBlurEffect as the example below :     <code>     BackgroundBlurEffect effect = new BackgroundBlurEffect();     view.SetRenderEffect(effect);     </code> |
...
| SetSourceView | `void SetSourceView(View sourceView)` | Set specific source view of background blur effects. If empty handle, works same as normal. |
| SetStopperView | `void SetStopperView(View stopperView)` | Set specific stopper view of background blur effects. If empty handle, works same as normal. |
